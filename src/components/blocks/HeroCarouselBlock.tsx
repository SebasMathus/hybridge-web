              ...
              <div style={{ position: 'relative', width: '100%', height: '100%', display: 'flex', alignItems: 'center' }}>
                ...
                <div className="container-hb" style={{ position: 'relative', zIndex: 2 }}>
                  <div style={{ maxWidth: '550px' }}>
                    ...
                    <Link href={slide.ctaUrl?.startsWith('/') ? `/${locale}${slide.ctaUrl}` : (slide.ctaUrl || '#')} data-track-id={slide.ctaTrackId || ''} style={btnStyles.cover}>{slide.ctaLabel || 'Más información'}</Link>
                  </div>
                </div>
              </div>
            </SwiperSlide>
