    ...
    <section style={{ position: 'relative', width: '100%', height: '70vh', minHeight: '400px', maxHeight: '650px', display: 'flex', alignItems: 'center' }}>
      ...
      <div className="container-hb" style={{ position: 'relative', zIndex: 2 }}>
        <div style={{ maxWidth: '600px' }}>
          ...
          {block.subheading && <p style={{ fontSize: '1.05rem', fontWeight: 500, color: 'rgba(255,255,255,0.9)', lineHeight: 1.6, marginBottom: block.campaignPriceLine ? '12px' : '28px', maxWidth: '500px' }}>{block.subheading}</p>}
          {block.campaignPriceLine ? (
            <p
              style={{
                fontSize: '1.05rem',
                fontWeight: 700,
