...
const ctaLunes = (prefix: string) => ({
  blockType: 'ctaSection', heading: 'En Hybridge iniciamos', highlightText: 'todos los lunes.', backgroundColor: 'cream',
  buttons: [
    { label: 'Inscríbete Ya', url: WA_INSC, variant: 'primary', trackId: `${prefix}-cta-inscribete` },
    { label: 'Contacta un asesor', url: WA_ASES, variant: 'secondary', trackId: `${prefix}-cta-asesor` },
    { label: 'Agenda una llamada', url: WA_CALL, variant: 'outline', trackId: `${prefix}-cta-llamada` },
  ],
})
...
const homeLayout = [
  {
    ...
    slides: [
      { line1: 'Ingeniería en', line2: 'Software', description: 'El mejor programa de ingeniería para las personas que aspiran a dominar el mundo de la tecnología.', imageUrl: IMG('2024/10/pexels-emirhan-albayrak-859465-20291643.jpg'), ctaLabel: 'Inscríbete ya', ctaUrl: '/contacto-ingenieria/', ctaTrackId: 'home-hero-software' },
      ...
      { line1: 'Hybridge', line2: 'Prepa', description: 'Haz la prepa en 2 años de la manera más disruptiva que te hayas imaginado.', imageUrl: IMG('2024/10/pexels-emirhan-albayrak-859465-20291643.jpg'), ctaLabel: 'Inscríbete ya', ctaUrl: '/contacto-preparatoria/', ctaTrackId: 'home-hero-prepa' },
    ],
  },
  logosBlock,
  ...
  { blockType: 'testimonialsRow', eyebrow: 'Universidad en Línea — Testimonios', heading: 'Nuestros estudiantes te cuentan cómo ha sido su experiencia estudiando en Hybridge', backgroundColor: 'cream', testimonials: uniTestimonials },
  {
...
const prepaLayout = [
  { blockType: 'heroBanner', heading: 'Haz la prepa en 2 años de la manera más disruptiva que te hayas imaginado.', imageUrl: IMG('2024/10/pexels-emirhan-albayrak-859465-20291643.jpg'), ctaLabel: 'Inscríbete ya', ctaUrl: '/contacto-preparatoria/', ctaTrackId: 'prepa-hero-cta' },
  logosBlock,
  { ...waBlock, trackId: 'prepa-wa-bar' },
  { blockType: 'videoSection', heading: 'CONOCE MÁS DE NUESTRA PREPA', subheading: 'Hybridge Preparatoria', youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', backgroundColor: 'white' },
  {
    ...
    imageUrl: IMG('2024/10/pexels-emirhan-albayrak-859465-20291643.jpg'), imagePosition: 'right', backgroundColor: 'white',
    buttons: [{ label: 'Inscríbete ya', url: '/contacto-preparatoria/', variant: 'primary', trackId: 'prepa-about-cta' }],
  },
  {
    ...
    buttons: [{ label: 'Inscríbete ya', url: '/contacto-preparatoria/', variant: 'primary', trackId: 'prepa-masque-cta' }],
  },
  {
  ...
  ctaLunes('prepa'),
  {
    blockType: 'curriculumTable', heading: 'Plan de estudios', subheading: 'Las materias que cursarás', description: 'Adquiere las habilidades para destacar en la era digital.',
    semesters: [
  ...
  { blockType: 'testimonialsRow', eyebrow: 'Testimonios Prepa', heading: 'Conoce Hybridge desde los ojos de nuestra comunidad', backgroundColor: 'cream', testimonials: uniTestimonials },
  {
    blockType: 'splitContent', eyebrow: 'Hybridge X', heading: 'En la prepa Hybridge tendrás acceso a HybridgeX',
    body: 'Una serie de webinars abordando los temas más importantes del momento, impartidos por mentores de la industria.',
    imageUrl: IMG('2024/11/SDFGB@2x.jpg'), imagePosition: 'right', backgroundColor: 'white',
    bulletPoints: [
      { text: 'Futuros posibles' }, { text: 'El metaverso' }, { text: 'Blockchain, Cryptos y Fintechs' },
      { text: 'La inteligencia artificial' }, { text: 'Biotecnología' },
    ],
  },
  { blockType: 'videoSection', heading: 'CONOCE MÁS DE NUESTRA PREPA', youtubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ', backgroundColor: 'cream' },
  {
    blockType: 'ctaSection', eyebrow: 'Recibe atención', heading: 'personalizada', backgroundColor: 'white',
...
const swLayout = [
  { blockType: 'heroBanner', heading: 'Ingeniería en Software', subheading: 'El mejor programa para las personas que aspiran a dominar el mundo de la tecnología.', imageUrl: IMG('2024/10/pexels-emirhan-albayrak-859465-20291643.jpg'), ctaLabel: 'Inscríbete ya', ctaUrl: '/contacto-ingenieria/', ctaTrackId: 'sw-hero-cta' },
  logosBlock,
  { ...waBlock, trackId: 'sw-wa-bar' },
  {
    ...
    imageUrl: IMG('2024/10/pexels-emirhan-albayrak-859465-20291643.jpg'), imagePosition: 'right', backgroundColor: 'white',
    buttons: [{ label: 'Inscríbete ya', url: '/contacto-ingenieria/', variant: 'primary', trackId: 'sw-about-cta' }],
  },
  { blockType: 'testimonialsRow', eyebrow: 'Universidad en Línea — Testimonios', heading: 'Nuestros estudiantes te cuentan cómo ha sido su experiencia', backgroundColor: 'cream', testimonials: uniTestimonials },
  {
  ...
  },
  {
    ...
    imageUrl: IMG('2024/11/sdc-1024x1024.png'), imagePosition: 'left', backgroundColor: 'cream',
    buttons: [{ label: 'Inscríbete ya', url: '/contacto-ingenieria/', variant: 'primary', trackId: 'sw-comunidad-cta' }],
  },
  ctaLunes('sw'),
  {
    blockType: 'curriculumTable', heading: 'Plan de estudios', subheading: 'Las materias que cursarás', description: 'Adquiere las habilidades para destacar en la era digital.',
...
export async function GET() {
  try {
    ...
    await payload.create({ collection: 'pages', data: { title: 'Inicio', slug: 'home', layout: homeLayout as any, meta: { title: 'Hybridge Education - La mejor escuela en línea', description: 'Preparatoria y universidad en línea con validez oficial.' } } })
    await payload.create({ collection: 'pages', data: { title: 'Preparatoria', slug: 'preparatoria', layout: prepaLayout as any, meta: { title: 'Preparatoria en Línea - Hybridge', description: 'Haz la prepa en 2 años de la manera más disruptiva.' } } })
    await payload.create({ collection: 'pages', data: { title: 'Ingeniería en Software', slug: 'ingenieria-en-software', layout: swLayout as any, meta: { title: 'Ingeniería en Software - Hybridge', description: 'El mejor programa de ingeniería para dominar la tecnología.' } } })

    return NextResponse.json({ success: true, message: 'Seeded: home, preparatoria, ingenieria-en-software' })
  } catch (error: any) {
